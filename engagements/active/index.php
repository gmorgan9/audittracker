                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><span class="badge" style="background-color: rgb(232,232,232); color: black; width: 80px;">0</span></td>
                          <td><span class="badge" style="background-color: rgb(244,244,254); color: black; width: 80px;">3</span></td>
                          <td>May 5, 2025</td>
                          <td>Completed</td>
                          <td>Apr 12, 2025</td>
                        </tr>
