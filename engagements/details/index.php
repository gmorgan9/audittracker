                        ...
                        ?>
                            <tr class="align-middle" style="cursor: pointer;" >
                                ...
                                <td>
                                    ...
                                    <a href="<?php BASE_URL; ?>/engagements/details/delete/?id=<?php echo $comment_id; ?>" data-bs-toggle="modal" data-bs-target="#comment_delete<?php echo $comment_id; ?>" class="badge text-bg-danger text-decoration-none">Delete</a>
