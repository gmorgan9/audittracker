                        ...
                        ?>
                            <tr class="align-middle" style="cursor: pointer;" >
                                ...
                                <td>
                                    ...
                                    <a href="<?php BASE_URL; ?>/engagements/details/delete/?id=<?php echo $comment_idno; ?>&eidno=<?php echo $comment_engagement_idno; ?>" class="badge text-bg-danger text-decoration-none">Delete</a>
